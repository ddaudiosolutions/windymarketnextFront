...
const productsSlices = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(obtenerProductosMasVistos.rejected, (state, action) => {
      // Error obteniendo productos más vistos
    });
    ...
    builder.addCase(crearNuevoProducto.rejected, (state, action) => {
      Swal.fire('Error', 'No se pudo crear el producto. Inténtalo de nuevo.', 'error');
    });
    builder.addCase(obtenerProductosUser.fulfilled, (state, action) => {
      state.productosUser = action.payload.data.prodUser;
    });
    builder.addCase(obtenerProductosUser.rejected, (state, action) => {
      state.productosUser = [];
    });
    ...
    builder.addCase(obtenerProductoIdApi.rejected, (state, action) => {
    ...
    builder.addCase(borrarProducto.rejected, (state, action) => {
    ...
    builder.addCase(editarProducto.rejected, (state, action) => {
